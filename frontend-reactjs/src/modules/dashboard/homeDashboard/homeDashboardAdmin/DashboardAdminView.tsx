...
import VModelAdminDashboard from "./VModelAdminDashboard.ts";

export default function DashboardAdminView() {
  const { products, users, discounts, categoryproducts } =
    VModelAdminDashboard();
  return (
    <PartialView>
      <div>
          ...
          <div className="container-fluid">
            ...
            <div className="row g-3">
              <div className="col-12 col-md-3">
                <a
                  href="/admin/manageproduct-product-admin"
              ...
              <div className="col-12 col-md-3">
                <a
                  href="/admin/manageproduct-discountproduct-admin"
                  className="card border-primary text-bg-light mb-3"
                  style={{
                    maxWidth: "13rem",
                    display: "flex",
              ...
              <div className="col-12 col-md-3">
                <a
                  href="/admin/manageproduct-categoryproduct"
                  className="card border-primary text-bg-light mb-3"
                  style={{
                    maxWidth: "13rem",
                    display: "flex",
